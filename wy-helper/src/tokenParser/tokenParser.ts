...
export const whiteSpaceRule = manyMatch(whiteSpaceMatch, 1);

export const whiteSpaceRuleZero = manyMatch(whiteSpaceMatch);
 ...
 * 使用try...catch来抛出错误...
 */
export type ParseFunGet<Q extends BaseQue<any>, T> = (
  que: Q
) => ParserSuccess<Q, T> | ParseError;
export function isParseSuccess<T extends ParserSuccess<any, any>>(
  v: T | ParseError
): v is T {
...
export function andRuleGet<Q extends BaseQue<any>, T, T1, T2>(
  args: [ParseFunGet<Q, T1>, ParseFunGet<Q, T2>],
  merge: (...vs: [T1, T2]) => T,
  message?: string
): ParseFunGet<Q, T>;
export function andRuleGet<Q extends BaseQue<any>, T, T1, T2, T3>(
  args: [ParseFunGet<Q, T1>, ParseFunGet<Q, T2>, ParseFunGet<Q, T3>],
  merge: (...vs: [T1, T2, T3]) => T,
  message?: string
): ParseFunGet<Q, T>;
...
export function andRuleGet<
  Q extends BaseQue<any>,
  T,
  T1,
  T2,
  T3,
...
>(
  ...
  merge: (...vs: [T1, T2, T3, T4, T5, T6, T7]) => T,
  message?: string
): ParseFunGet<Q, T>;
...
>(
  ...
  merge: (...vs: [T1, T2, T3, T4, T5, T6, T7, T8]) => T,
  message?: string
): ParseFunGet<Q, T>;
...
>(
  ...
  merge: (...vs: [T1, T2, T3, T4, T5, T6, T7, T8, T9]) => T,
  message?: string
): ParseFunGet<Q, T>;
...
export function orRuleGet<Q extends BaseQue<any>, T1, T2>(
  rules: [ParseFunGet<Q, T1>, ParseFunGet<Q, T2>],
  message?: string
): ParseFunGet<Q, T1 | T2>;
export function orRuleGet<Q extends BaseQue<any>, T1, T2, T3>(
  rules: [ParseFunGet<Q, T1>, ParseFunGet<Q, T2>, ParseFunGet<Q, T3>],
  message?: string
...
export function alawaysGet<Q extends BaseQue<any>, T>(
  callback: (que: Q) => T
): ParseFunGet<Q, T>;
