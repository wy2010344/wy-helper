...
export function waitUntilQuit(
  ...
  let beforeTargetRect = defaultRect,
    beforePopoverRect = defaultRect;
  return new Promise(resolve => {
    function check() {
      ...
      if (currentTargetRect && currentPopoverRect) {
        if (
          equalRect(beforeTargetRect, currentTargetRect) &&
          equalRect(beforePopoverRect, currentPopoverRect)
        ) {
          resolve({
