...
export type FSvgAttribute<T extends SvgElementType> = BSvgAttribute<T> &
  FDataAttr &
  FAriaAttribute &
  FStyleProps &
  FCssVaribute;
 ...
 * @returns
 */
function createRenderFAttr(updateMAttr: UpdateProp) {
  return function (
    node: Node,
    arg: any,
    mergeValue: MergeValue,
 ...
 * @returns
 */
function createMergeFNodeAttr(updateMAttr: UpdateProp) {
  return function (
    node: Node,
    attrs: Props,
    oldAttrs: Props,
